...
const SignInSeller = () => {
    ...
    const handleSubmit = (e) => {
        ...
        fetch('http://localhost:8081/login', {
            ...
            .then(async res => {
                ...
                setSellerId(data.userID); // Assuming the server returns the seller ID

                console.log('Name:', data.username); // Debugging line
                console.log('Seller ID:', data.userID); // Debugging line
    ...
    const confirmModal = () => {
        console.log('Navigating to SellerHome with:', { name, sellerId });
        setShowModal(false);
        navigate('/seller-home', { state: { name, sellerId } });
    };
